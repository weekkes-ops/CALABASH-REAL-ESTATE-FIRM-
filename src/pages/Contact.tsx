          ...
          <div className="lg:col-span-1 space-y-12">
            <div>
              ...
              <div className="space-y-8">
                ...
                <a href="https://api.whatsapp.com/send?phone=23276555012" target="_blank" rel="noreferrer" className="flex items-center group p-4 rounded-3xl hover:bg-gray-50 transition-all">
                  <div className="w-14 h-14 bg-[#25D366] rounded-2xl flex items-center justify-center text-white mr-6 group-hover:scale-110 transition-transform shadow-lg shadow-[#25D366]/20">
                  ...
                  <div>
                    <div className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-1">WhatsApp Admin</div>
                    <div className="text-xl font-serif text-primary">Chat with us directly</div>
                  </div>
                </a>
              </div>
            </div>
